...
class InventoryTransaction(models.Model):
    ...
    supplier = models.ForeignKey(Person, on_delete=models.CASCADE)
    ...
    expense_type = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='transaction_expense_type')
    vehicle = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='transaction_vehicle_type')
